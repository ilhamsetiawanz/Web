    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('laporan-bulanan') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition duration-300">
        ...
        <div class="p-6">
            ...
            @if ($diagnosisPenyakit)
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg mb-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">Informasi Pasien</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <p class="text-sm text-gray-600">
                                    <span class="font-medium">Nama Pasien:</span> 
                                    {{ $report->user->name ?? 'Tidak tersedia' }}
                                </p>
                            ...
                            <div class="space-y-4">
                                @if($diagnosisPenyakit->reason)
                                    <div class="bg-blue-50 p-4 rounded-lg">
                                        <h3 class="font-semibold text-blue-800 mb-2">Penyebab</h3>
            ...
            <div class="mt-8 text-right">
                <p class="text-sm text-gray-600">DiDiagnosa Oleh:</p>
                <p class="font-medium text-gray-800 mt-1">{{ $report->user->name ?? 'Tidak tersedia' }}</p>
            </div>
        </div>
    </div>
</div>
